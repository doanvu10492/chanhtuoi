...
Class Facebook
{
    ...
    public function __construct(){
        ...
        switch ($this->config->item('facebook_login_type')){
            ...
            case 'web':
                ...
                if (isset($_GET['state'])) { $this->helper->getPersistentDataHandler()->set('state', $_GET['state']); }
                break;
        }
    ...
    private function authenticate(){
        ...
        if(!$access_token){
            try{
                $access_token = $this->helper->getAccessToken("https://cameramekong.com/login-facebook");
            }catch (FacebookSDKException $e){
