...
class Groups extends Admin_Controller
{
  ...
  {
    $this->outputData['page_title'] = 'Create group';
    $this->outputData['current_page'] = 'groups';
    $this->outputData['sub_page'] = 'groups';
  ...
  public function edit($group_id = NULL)
  {
    ...
    $this->outputData['page_title'] = 'Edit group';
    $this->load->library('form_validation');
