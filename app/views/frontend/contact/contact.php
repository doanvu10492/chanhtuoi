            ...
            <form id="contactform" name="contact" method="post" action="./lien-he.html"  enctype="multipart/form-data">
               <div class="col-md-6">
                  <div class="form-contact ">
                     <div class="contact-form box-contact-form row">
               ...
               <div class="col-md-12">
                    <div class="form-group">
                        <button type="submit" class="btn btn-submit btn-primary pull-left">Gửi</button>
                        <button type="reset" class="btn btn-submit btn-secondary pull-left" style="margin-left: 10px">Hủy</button>
                    </div>
               </div>
            </form>
         </div>
