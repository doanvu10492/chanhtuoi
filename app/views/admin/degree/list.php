<div class="action-list-admin">
     <ul class="list-inline ">
          <li><a href="<?php echo admin_url('degree/updated/0');  ?>"><i class="fa fa-plus" aria-hidden="true"></i>Thêm</a></li>
     </ul>
</div>
...
<div class="box-body table-responsive" id="list-pro">
	...
	<div class="box-pagination clearfix" id="example2_paginate">
	    <div class="action-table-quick pull-left">
	    	   <input type="checkbox" name="checklist_box" id="check_all"> Check All | <a id="del-all" href="<?=admin_url('degree/del_list_choose')?>"><i class="fa fa-close"></i> Delete </a>
	    </div>
	    <?=$pagination?>
    </div>
