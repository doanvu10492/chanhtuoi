<div class="action-list-admin">
     <ul class="list-inline ">
          <li><a href="<?php echo admin_url('trademark/updated/0');  ?>"><i class="fa fa-plus" aria-hidden="true"></i>Thêm</a></li>
     </ul>
</div>
...
<div class="box">
	...
	<table class="table table-bordered table-hover" role="grid">
		<thead>
		    <tr>
				...
				<th>Tiêu đề</th>
	            <th>Ngày đăng</th>
	            <th class="text-center width55">isMenu</th>
	...
	<div class="box-pagination clearfix" id="example2_paginate">
	    <div class="action-table-quick pull-left">
	    	   <input type="checkbox" name="checklist_box" id="check_all"> Check All | <a id="del-all" href="<?php echo admin_url('trademark/del_list_choose'); ?>"><i class="fa fa-close"></i> Delete </a>
	    </div>
