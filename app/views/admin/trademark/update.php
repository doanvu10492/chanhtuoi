...
<div class="nav-tabs-custom">
    ...
    <form action="<?php echo admin_url('trademark/updated/'.$id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="tab-content">
				        ...
				        <div class="col-md-12">
				           ...
				           <div class="form-group">
				            ...
				            <div class="form-group">
				                ...
				                <div class="col-sm-10">
				                    <input type="text" name="link" class="form-control" value="<?php echo (isset($page->link)) ? ($page->link) : (set_value('link')); ?>"  placeholder="Tên website">
				                    <p class="error"><?php echo form_error('link'); ?></p>
				                </div>
			            	</div>
				      ...
				      <div class="row">
				        <div class="col-md-12">
				            ...
				            <div class="form-group">
				                <label for="inputEmail3" class="col-sm-2 control-label">Liên kết:</label>
				                <div class="col-sm-10">
				                    <input type="text" name="alias_en" class="form-control" value="<?php echo (isset($page->alias_en)) ? ($page->alias_en) : (set_value('alias_en')); ?>"  placeholder="Tên website">
				                    <p class="error"><?php echo form_error('alias_en'); ?></p>
				                </div>
			            	</div>
		    ...
		    <div class="form-group overload-hidden">
                ...
                <div class="col-sm-10">
					<input type="submit" class="submit blue-btn" value="<?php echo $action; ?>" name="update_trademark">
				</div>
			</div><!-- /.form-field -->																								
          </div>
        <!-- /.tab-content -->
