...
<div class="nav-tabs-custom">
    ...
    <form action="<?php echo admin_url('translate/updated/'.$id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
				      ...
				      <div class="row">
				        <div class="col-md-12">
				            ...
				            <div class="form-group">
				                ...
				                <div class="col-sm-10">
				                    <input type="text" name="code" class="form-control" value="<?php echo (isset($page->code)) ? ($page->code) : (set_value('code')); ?>"  placeholder="Tên website">
