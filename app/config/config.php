...
|
*/
$config['base_url']	= "http://chanhtuoi.co/";
$config['site_url'] =  "http://chanhtuoi.co/";
...
|
*/
$config['encryption_key'] = "RWnfu347h53A3";
...
$config['sess_save_path'] = sys_get_temp_dir(); // table name
/*
|--------------------------------------------------------------------------
...
$config['img_admin']			  = 	"assets/img/admin";  	//FckEditor	Width

//File upload limit
$config['projects_width'] =	350; 
$config['projects_height'] = 270; 
$config['posts_width'] = 300; 
$config['posts_height']	= 270; 
$config['album_width'] = 260; 
$config['album_height'] = 180; 
$config['small_posts_width'] = 130; 
$config['small_posts_height'] =	90; 
$config['products_width'] = 280; 
$config['products_height'] = 430; 
$config['support_width'] = 300; 
$config['support_height'] = 270;
